...
<div class="group inline-block relative" use:clickOutside on:click_outside={handleClickOutside}>
  <button
    class="bg-coopmaths hover:bg-coopmaths-light  text-coopmaths-back text-xl font-extrabold relative flex lg:block py-6 px-2 lg:px-8 items-center"
    {id}
  ...
  <ul class="lg:absolute right-0 {isMenuOpen ? 'block' : 'hidden'} text-coopmaths-back w-56 filter drop-shadow-xl z-50">
