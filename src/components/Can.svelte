...
<div class={$darkMode.isActive ? "dark" : ""}>
  <div class="flex bg-coopmaths-canvas dark:bg-coopmathsdark-canvas ">
    ...
    <main
      class="bg-coopmaths-canvas text-coopmaths-corpus dark:bg-coopmathsdark-canvas dark:text-coopmathsdark-corpus"
    >
            ...
            {#if nbOfVues > 1}
              ...
              >
                ...
                <button type="button" class="pl-4"
                  ><i
                    class="text-coopmaths-action hover:text-coopmaths-action-lightest dark:text-coopmathsdark-action dark:hover:text-coopmathsdark-action-lightest bx bx-sm bx-refresh"
                  /></button
                >
              </div>
            {:else}
              ...
              >
                ...
                isQuestionsVisible
                  ? " / "
                  : ""}{isCorrectionVisible ? "Réponses" : ""}<button
                  type="button"
                  class="pl-4"
                  ><i
                    class="text-coopmaths-action hover:text-coopmaths-action-lightest dark:text-coopmathsdark-action dark:hover:text-coopmathsdark-action-lightest bx bx-sm bx-refresh"
                ...
                <div>
                  <div class="flex flex-row my-4">
                    <div class="flex flex-col justify-start items-center pr-2">
                      <span
                        class="inline-flex text-center text-coopmaths-struct dark:text-coopmathsdark-struct font-black text-lg"
                        >{i + 1}.</span
                      >
                    </div>
                    <div class="flex flex-col justify-start items-start">
                      ...
                      {#if isCorrectionVisible || correctionsSteps.includes($questionsOrder.indexes[i])}
                        ...
                        >
                          {@html MathaleaFormatExercice(
                            corrections[currentVue][$questionsOrder.indexes[i]]
                          )}
                          <div
            ...
            <div class="flex flex-row justify-evenly w-full">
              {#each Array(nbOfVues) as _, currentVueId}
                <div style="width: {100 / nbOfVues}%">
                  <div
                    class="flex flex-row justify-start items-center text-3xl font-black text-coopmaths-struct dark:text-coopmathsdark-struct p-6"
                  >
