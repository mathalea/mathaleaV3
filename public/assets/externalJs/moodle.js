    ...
    connectedCallback() {
      ...
      const addIframe = () => {
        ...
        if (VERSION === 3) {
          ...
          iframe.setAttribute('src', SERVEUR_URL + '/?' + this.getAttribute('url') + '&i=1&v=eleve&recorder=moodle&title=&es=0110&iframe=' + iMoodle + (this.getAttribute('correction') !== null ? '&done=1' : '') + (typeof answer !== 'undefined' ? '&reponses=' + answer : ''))
        } else {
