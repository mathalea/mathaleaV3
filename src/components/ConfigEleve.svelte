...
<main class="mb-auto flex flex-col justify-between h-screen bg-coopmaths-canvas dark:bg-coopmathsdark-canvas {$darkMode.isActive ? 'dark' : ''}">
  ...
  <div class="h-full flex flex-col p-4 md:px-36 md:py-10 bg-coopmaths-canvas dark:bg-coopmathsdark-canvas">
    <div class="flex flex-col md:flex-row justify-start px-4 py-2">
